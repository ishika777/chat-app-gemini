...
const Home = () => {
    ...
    return (
        ...
        <main className='p-4'>
            <div className="projects flex flex-col flex-wrap gap-3">
                ...
                <div className='flex flex-wrap gap-4'>
                    {
                        allProjects.map((project) => (
                            <div key={project._id}
                                ...
                                className="project flex flex-col gap-2 cursor-pointer p-4 border border-slate-300 rounded-md min-w-52 hover:bg-slate-100">
                                <h2
